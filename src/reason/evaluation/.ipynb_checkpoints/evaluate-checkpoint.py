...
cot_prompt_dict = {
    ...
    'qwen': """Please reason step by step, only insert the marker 'ки\n' after completing a major reasoning step, not after every sentence, and put your final answer within \\boxed{}.""",
    'default': """Please reason step by step, only insert the marker 'ки\n' after completing a major reasoning step, not after every sentence, and put your final answer within \\boxed{}""",
}
...
if __name__ == "__main__":
    ...
    def dynamic_solver_fn(problem_inst, lm_calls, rm_call):
        ...
        dyn_beam_config = BeamSearchConfig(
            ...
            beam_size=dynamic_params.get("beam_size", dyn_tree_max_width),  
            model_names=args.LM,  
        ...
        search_tree = SearchTree(
            cfg={"model_names": dyn_beam_config.model_names, "direct_io": dyn_beam_config.direct_io,
                 "max_actions": dyn_beam_config.tree_max_width})
        traj_list = search_tree.beam_search(env, dyn_beam_config.beam_size, dyn_beam_config.tree_max_depth, rm_call)
